    ...
    <div class="page-container">
      ...
      <div class="page-header">
        <div class="breadcrumb">
          <span class="breadcrumb-item active">Изхранване</span>
      ...
      <div class="page-content">
        <div class="content-header">
          <h1 class="page-title">Изхранване</h1>
        ...
        <div class="content-card">
          ...
          <div class="table-container" *ngIf="!loading; else loadingTemplate">
            <table class="data-table">
              ...
              <tbody>
                <tr *ngFor="let feedingType of feedingTypes" class="table-row">
                  <td class="font-medium">{{feedingType.name}}</td>
                  <td>{{feedingType.description}}</td>
                  <td>
          ...
          <ng-template #loadingTemplate>
            <div class="loading-state">
              ...
              <span>Зареждане на типове изхранване...</span>
            </div>
          </ng-template>
